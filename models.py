...
class ClaimCheckResponse(BaseModel):
    ...
    """
    verdict: Literal["SUPPORT", "REFUTE", "NOT_FOUND", "UNKNOWN", "ERROR"] = Field(
        description="The verdict on the claim. Must be exactly one of: SUPPORT, REFUTE, NOT_FOUND, UNKNOWN or ERROR"
    )
